                        ...
                        <div class="live-preview">
                            <form id="form_submit" class="row g-3 needs-validation" novalidate>
                                <div class="col-md-4">
                                    ...
                                    <input type="hidden" id="module_name" value="Group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="course_benefits" oninput="AlphaNumericValidation(this)" placeholder="Enter Group Benefits"
                                        rows="3" class="form-control" required>{{ old('course_benefits') }}</textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="course_description" oninput="AlphaNumericValidation(this)" placeholder="Enter Group Description"
                                        rows="3" class="form-control" required>{{ old('course_description') }}</textarea>

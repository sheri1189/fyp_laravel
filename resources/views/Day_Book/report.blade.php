        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Expenses Reports</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ url('/report_daybook') }}">Reports</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">View Expenses Reports</h5>
                    </div>
                    <div class="card-body">
                        <div class="card-body">
                            <div class="live-preview">
                                <form id="form_submit" class="row g-3 needs-validation" novalidate>
                                    <div class="col-4">
                                        ...
                                        <select name="category_name" id="category_id" class="single-select" required>
                            ...
                            <tbody id="append_data">
                                ...
                                @foreach ($alldata as $data)
                                    <tr>
                                        <td>{{ $num++ }}</td>
                                        <td>
                                            @if ($array_data[$data->id]['category_type'] == 'Expenses')
                                                <h5><span class="badge badge-soft-primary">Expenses</span></h5>
                                            @else
                                                <h5><span class="badge badge-soft-success">Revenue</span></h5>
                                            @endif
                                        </td>
                                        <td>{{ $array_data[$data->id]['category_name'] }}</td>
                                        <td>{{ $data->date }}</td>
                                        <td>
                                            <h5><span class="badge bg-primary">{{ 'Rs.' . $data->amount }}</span></h5>
                                        </td>
                                        <td>{{ $data->remark }}</td>
                                    </tr>
                                @endforeach
                    ...
                    success: function(response) {
                        if (response.message == 300) {
                            ...
                            $.each(response.message, function(index, item) {
                                count++;
                                var split_date = item.date;
                                var categoryType = (response.message2[item.id][
                                        'category_type'
                                    ] == "Expenses") ?
                                    "<h5><span class='badge badge-soft-primary'>Expenses</span></h5>" :
                                    "<h5><span class='badge badge-soft-success'>Revenue</span></h5>";
                                $("#append_data").append("<tr><td>" + count +
                                    ...
                                    "</td><td><h5><span class='badge bg-primary'>Rs." +
                                    item.amount +
                                    "</span></h5></td><td>" + item.remark +
                                    "</td></tr>");
                            });
                        }
                    }

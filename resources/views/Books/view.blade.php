            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">View Books</h5>
                    </div>
                            ...
                            <tbody>
                                ...
                                @forelse ($allbooks as $books)
                                    <tr>
                                        ...
                                        <td>{{ ucfirst($books->degreename->degree_name) }}</td>
                                        <td>{{ ucfirst($books->programname->program_name) }}</td>
                                        <td>{{ ucfirst($books->classname->classes_name) }}</td>
                                        <td>
                                            @php
                                                $unser = unserialize($books->subject);
                                            @endphp
                                            @foreach ($unser as $sub)
                                                <span class="badge badge-soft-primary">{{ $sub . ',' }}</span>
                                            @endforeach
                                        </td>
                                        <td>
                                            {{ $books->created_at }}

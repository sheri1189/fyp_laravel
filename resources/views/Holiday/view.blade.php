                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ url('/holiday_view') }}">Holiday</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h5 class="card-title mb-0">View Holiday</h5>
                            </div>
                            <div class="col-6 text-end">
                                <a href="{{ url('/holiday_add') }}" class="btn btn-primary">+ Add Holidays</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="example2" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @php
                                    $num = 1;
                                @endphp
                                @forelse ($allholiday as $holiday)
                                    <tr>
                                        <td data-ordering="false">{{ $num++ }}</td>
                                        <td>{{ $holiday->holiday_name }}</td>
                                        <td>
                                            <h5><span class="badge badge-soft-primary">{{ "Holiday" }}</span></h5>
                                        </td>

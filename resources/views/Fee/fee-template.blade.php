                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr
                                                ...
                                                <td class="content-block"
                                                    ...
                                                    valign="top">
                                                    <p style="margin-bottom: 0;">We are relaying this message as a reminder of an unpaid monthly tuition fee due on “{{ $body['date'] }}”. It is now “{{ $body['date'] }}”, and we are yet to process your payment. Please settle your account as soon as possible. Thank you !”</p>
                                                </td>
                                            </tr>
                                            <tr
                                                style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                <td class="content-block"
                                                    ...
                                                    <p
                                                        ...
                                                        2023 thenestacademy. Design & Develop by Waqee Ahmed & Mubushra</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>

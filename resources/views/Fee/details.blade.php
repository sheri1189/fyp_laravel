...
@section('main-content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Student Fee Details</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ url('/all_fee') }}">Student Fee Details</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">View Student Fee Details</h5>
                    </div>
    ...
    @forelse ($allfee as $fee)
        @if (isset($array_student[$fee['student_id']]))
            <tr>
                ...
                <td>{{ $array_student[$fee['student_id']]['contact_no'] }}</td>
                <td>
                    <h5><span class="badge badge-soft-secondary">{{ $fee['month'] }}</span></h5>
                </td>
                <td>
    ...
    @empty
        <tr>
            <td colspan="9" align="center" style="color:#004454;font-weight:bold;">No Data Available</td>
        </tr>
    @endforelse
</tbody>
                        </table>

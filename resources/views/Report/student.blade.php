    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Students Attendance Report</h4>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">View Students Attendance Report</h5>
                    </div>
                    <div class="card-body">
                        <div class="card-body">
                            <div class="live-preview">
                                <form id="form_submit" class="row g-3 needs-validation" novalidate>
                                    <div class="col-6">
                                        ...
                                        <select name="category_name" id="student_id" class="single-select" required>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">View Student Attendance Reports</h5>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h5><span class='badge badge-label bg-primary'><i
                                                    ...
                                                    {{ 'Reg-' . $data->registeration_no }}</span></h5>
                                        </td>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(document).on("change", "#period", function(stop) {
                ...
                $.ajax({
                    url: "/select_students/" + period_name,
                    method: "GET",
                    data: {
                        ...
                        if (response.message == 300) {
                            ...
                            $.each(response.message, function(index, item) {
                                ...
                                $("#append_data").append("<tr><td>" + count +
                                    "</td><td><h5><span class='badge badge-label bg-primary'><i class='mdi mdi-circle-medium'></i>Reg- " +
                                    item.registeration_no +
                                    "</span></h5></td><td>" + item.student_name +
                                    "</td><td>" + item.date +
                                    "</td><td>" + item.time +
                                    "</td><td>" + type +
                                    "</td></tr>");

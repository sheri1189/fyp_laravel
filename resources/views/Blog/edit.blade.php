        ...
        <div class="row">
                            ...
                            <form id="form_update" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="blog_title" oninput="NameValidation(this)"
                                        ...
                                        value="{{ ucfirst($blog->blog_title) }}" required>
                                    <strong id="blog_title" class="text-danger"></strong>
                                </div>
                                <div class="col-md-6">
                                    <label for="validationCustom01" class="form-label">Picture</label>
                                    <input type="file" name="blog_image" value="{{ $blog->blog_image }}" class="form-control"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="blog_description" oninput="AlphaNumericValidation(this)" placeholder="Enter Blog Description"
                                        rows="3" class="form-control" required>{{ $blog->blog_description }}</textarea>
            ...
            <div class="col-lg-3" id="image_thumbnail">
                <img class="img-thumbnail" alt="200x200" width="450" height="200"
                    src="{{ asset('admin/assets/images/blog/' . $blog->blog_image) }}">
            </div>
        </div>
    </div>
    </div>

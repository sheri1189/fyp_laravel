                                ...
                                <div class="col">
                                    <div class="p-2">
                                        ...
                                        <h3 class="text-white mb-1" id="name">{{ $greeting }},
                                            {{ $user->name }}!</h3>
                                        <p class="text-white text-opacity-75" id="enter_type">{{ 'Teacher' }}</p>
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table table-borderless mb-0">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <th class="ps-0" scope="row">Teacher
                                                                                Assigned Rooms :
                                                                            </th>
                                                                            @php
                                                                                $unserclass = unserialize($user->class);
                                                                            @endphp
                                                                            <th class="text-muted">
                                                                                @foreach ($unserclass as $unsercl)
                                                                                    <span
                                                                                        class="badge badge-soft-primary">{{ $array_class[$unsercl] }}</span>
                                                                                @endforeach
                                                                            </th>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            @php
                                                                                $unserpromram = unserialize($user->program);
                                                                            @endphp
                                                                            <th class="text-muted">
                                                                                @foreach ($unserpromram as $unserpro)
                                                                                    <span
                                                                                        class="badge badge-soft-primary">{{ ucfirst($array_program[$unserpro]) }}</span>
                                                                                @endforeach
                                                                            </th>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <th class="text-muted">
                                                                                {{ $user->teacher_university . ' Univeristy' }}
                                                                            </th>
                                                                        </tr>
                                                                        <tr>
                                                                            <th class="ps-0" scope="row">Teacher
                                                                            ...
                                                                            @php
                                                                                $unserialize = unserialize($user->teacher_professional_field);
                                                                            @endphp
                                                                            <th class="text-muted">
                                                                                @foreach ($unserialize as $unser)
                                                                                    <span
                                                                                        class="badge badge-soft-primary">{{ $unser }}</span>
                                                                                @endforeach
                                                                            </th>
                                                                        </tr>
                                                                    </tbody>

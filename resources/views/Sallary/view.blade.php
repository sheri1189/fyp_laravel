                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ url('/teacher_salary') }}">Salary</a></li>
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-6 text-end">
                                <a href="{{ url('/add_salary') }}" class="btn btn-primary">+ Add Salary</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="example2" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @php
                                    $num = 1;
                                @endphp
                                @forelse ($allsalary as $salary)
                                    <tr>
                                        <td data-ordering="false">{{ $num++ }}</td>
                                        <td><img src="{{ asset('/admin/assets/images/instructors/' . $salary->teacher->teacher_picture) }}"
                                        ...
                                        <td>
                                            <h5><span class="badge badge-label bg-primary"><i
                                                    ...
                                                    {{ 'Reg-' . $salary->teacher->registeration_no }}</span></h5>
                                        </td>
                                        <td>
                                            <h5><span class="badge badge-label bg-primary"><i
                                                        class="mdi mdi-circle-medium"></i>
                                                    {{ $salary->voucher_number }}</span></h5>
                                        </td>
                                        <td>
                                            <h5><span class="badge bg-primary">{{ $salary->month }}</span></h5>
                                        </td>
                                        <td>{{ ucfirst($salary->teacher->name) }}</td>
                                        <td>{{ $salary->teacher->email }}</td>
                                        <td>{{ $salary->teacher->contact_no }}</td>
                                        <td>
                                            <h5><span
                                                    class="badge badge-soft-primary">{{ 'Rs. ' . $salary->net_salary }}</span>
                                            </h5>
                                        </td>
                                        <td>
                                            <h5><span
                                                    class="badge badge-soft-success">{{ 'Rs. ' . $salary->net_salary }}</span>
                                            </h5>
                                        </td>
                                        <td>
                                            <form>
            ...
            $(document).on("click", ".detail", function(stop) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#degree").append(titleCase(response.message.teacher_degree));
                        $("#program").append(titleCase(response.message.teacher_program));

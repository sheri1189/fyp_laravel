                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ url('/notice') }}">Notice Board</a></li>
            ...
            <div class="col-lg-6 mx-auto">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Add Notice Board</h4>
                    </div>
                    <div class="card-body">
                        <div class="live-preview">
                            <form id="form_submit" class="row g-3 needs-validation" novalidate>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="notice_name"
                                        value="{{ old('notice_name') }}" placeholder="Enter Notice Name" autocomplete="off"
                                        required oninput="NameValidation(this)">
                                    <strong class="text-danger" id="notice_name"></strong>
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label">Notice Description *</label>
                                    <textarea name="notice_description" id="notice_description" rows="3" oninput="AlphaNumericValidation(this)"
                                        required class="form-control" placeholder="Enter Notice Description">{{ old('notice_description') }}</textarea>
                                    <strong class="text-danger" id="notice_description"></strong>
                                </div>
                                <div class="col-6">
                                    <a href="{{ url('/notice') }}" type="submit" id="button_move"

                        ...
                        <table id="example2" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @php
                                    $num = 1;
                                @endphp
                                @forelse ($allassignments as $assignments)
                                    <tr>
                                        ...
                                        <td>
                                            <h5><span class="badge badge-soft-primary cursor-pointer" id="downloadButton" data-file="{{ $assignments->upload_file }}"><i
                                                class="fas fa-file-download"></i> Download File</span></h5>
                                        </td>
                                        <td>
                                            <form>
                                                <input type="hidden" id="get_url" value="/assignments">
                                                <input type="hidden" id="module_name" value="Assignments">
                                            </form>

            ...
            <div class="col-lg-6 mx-auto">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Update Assignment</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <form id="form_update" class="row g-3 needs-validation" novalidate>
                                    ...
                                    <select class="single-select" name="instructor" id="teacher_name" autocomplete="off" required>
                                        ...
                                        @foreach ($allteacher as $teacher)
                                            <option value="{{ $teacher->id }}"
                                                {{ $test->instructor == $teacher->id ? 'selected' : '' }}>
                                    ...
                                    <select class="single-select" name="degree" id="degree_getting" autocomplete="off" required>
                                        ...
                                        @foreach ($alldegree as $degree)
                                            <option value="{{ $degree->id }}"
                                                {{ $assignment->degree == $degree->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="single-select" name="program" required id="program" autocomplete="off">
                                        <option value="" selected disabled>Choose The Degree First</option>
                                    </select>
                                    ...
                                    <select class="single-select" name="class" id="subject_getting" autocomplete="off" required>
                                        ...
                                        @foreach ($array_subjects as $subjects)
                                            <option value="{{ $subjects }}"
                                                {{ $assignment->class == $subjects ? 'selected' : '' }}>{{ $subjects }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="date" name="end_time" value="{{ $assignment->end_time }}" class="form-control" required>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-6 text-end">
                                        <button class="btn rounded-pill btn-primary waves-effect waves-light" type="submit"
                                            id="update">Update Assignment > </button>
                                    </div>
                                </div>
                            </form>
                        </div>

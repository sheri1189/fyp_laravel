                            ...
                            <form id="form_submit" class="row g-3 needs-validation" novalidate>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="registeration_no" value="{{ $registeration_no }}"
                                        placeholder="Enter Registeration  Number" class="form-control" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="single-select" name="session" autocomplete="off" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" value="batch-" id="syear"
                                        name="batch">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-6 text-end">
                                        <button class="btn rounded-pill btn-primary waves-effect waves-light"
                                            type="submit" id="insert">Add Inquiry > </button>
                                    </div>
                                </div>
                            </form>
                        </div>

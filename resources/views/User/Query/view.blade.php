                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-borderless mb-0">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <th class="ps-0" scope="row">Course :
                                                                                </th>
                                                                                <th class="text-muted" id="program">
                                                                                </th>
                                                                            </tr>
                                                                            <tr>
                                                                                <th class="ps-0" scope="row">Class :
                                                                                </th>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">View Inquiry</h5>
                    </div>
                        ...
                        <table id="example2" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @php
                                    $num = 1;
                                @endphp
                                @forelse ($allquery as $query)
                                    <tr>
                                        <td data-ordering="false">{{ $num++ }}</td>
                                        <td><img src="{{ asset('/admin/assets/images/users/dummy.jpg') }}"
                                                alt="img not found" class="avatar-md rounded-pill img-thumbnail"></td>
                                        <td>
                                            <h5><span class="badge badge-label bg-primary"><i
                                                        class="mdi mdi-circle-medium"></i>
                                                    {{ 'Reg-' . $query->registeration_no }}</span></h5>
                                        </td>
                                        <td>
                                            <h5><span
                                                    class="badge bg-light text-dark">{{ ucfirst($program_array[$query->id]) }}</span>
                                            </h5>
                                        </td>
                                        ...
                                        <td>
                                            <h5><span class="badge badge-soft-primary">{{ 'Inquiry' }}</span></h5>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a href="{{ url('/inquiry/' . $query->id . '/edit/') }}"
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item remove-item-btn delete"
                                                            data-del="{{ $query->id }}" style="cursor: pointer;">
                                                            <i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i>
                                                            Delete
                                                        </a>
                                                    </li>
                                                    <li><a class="dropdown-item edit-item-btn detail"
                                                            data-detail="{{ $query->id }}" style="cursor: pointer;"><i
                                                                class="fas fa-user align-bottom me-2 text-muted"></i>
                                                            Profile</a></li>
                                                    <li><a class="dropdown-item edit-item-btn approve"
                                                            data-approve="{{ $query->id }}"
                                                            style="cursor: pointer;"><i
                                                                class="fas fa-user align-bottom me-2 text-muted"></i>
                                                            Approve for Student</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
...
@section('script')
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on("click", ".approve", function(stop) {
                stop.preventDefault();
                const titleCase = (s) => s.replace(/\b\w/g, c => c.toUpperCase());
                var value = $(this).data("approve");
                var element = this;
                $.ajax({
                    url: "/approve_for_student/" + value,
                    method: "GET",
                    success: function(response) {

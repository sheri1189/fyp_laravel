            ...
            <div class="col-lg-9 mx-auto">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Update Student</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <form id="form_update" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="single-select" name="program" id="program" autocomplete="off" required>
                                        <option selected disabled>--Select the Degree First--</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="single-select" name="session" autocomplete="off">
                                        <option selected disabled>--Select the Session--</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="single-select" name="student_status" id="student_status_select"
                                        onchange="showHideStartDate()" required>
                                ...
                                <div class="col-md-4" id="start_date_div" style="display: none">
                                    ...
                                    <input type="date" name="start_date" value="{{ $get_user->start_date }}"
                                        class="form-control">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @php
                                        $implode = implode(',', unserialize($get_user->student_total_subjects));
                                    @endphp
                                    <br>
                                    <input type="text" name="student_total_subjects" value="{{ $implode }}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" value="{{ $get_user->student_total_fee }}"
                                        name="student_total_fee" id="student_subtotal" placeholder="Add Sub-Total Fees"
                                        class="form-control" required />
                                    <strong class="text-danger" id="student_total_fee"></strong>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Discount *</label>
                                    <input type="number" name="student_discount_fee"
                                        value="{{ $get_user->student_discount_fee }}" id="student_discount"
                                        placeholder="Add Discount" class="form-control" required />
                                    <strong class="text-danger" id="student_discount_fee"></strong>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Total Fees Amount *</label>
                                    <input type="number" name="student_after_discount_fee"
                                        value="{{ $get_user->student_after_discount_fee }}" id="student_total"
                                        placeholder="Total Fees Amount" class="form-control" required />
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-6 text-end">
                                        <button class="btn rounded-pill btn-primary waves-effect waves-light"
                                            type="submit" id="update">Update Student > </button>
                                    </div>
                                </div>
                            </form>
                        </div>

        ...
        <div class="row">
            <div class="col-lg-9 mx-auto">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Update Teacher</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <form id="form_update" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="name" value="{{ $get_user->name }}"
                                        placeholder="Enter Teacher Name" class="form-control" value="{{ old('name') }}"
                                        required>
                                    <strong class="text-danger" id="name"></strong>
                                </div>
                                <div class="col-md-4">
                                    <label for="validationCustom01" class="form-label">Father Name </label>
                                    <input type="text" name="father_name" value="{{ $get_user->father_name }}"
                                        oninput="NameValidation(this)" placeholder="Enter Father Name" class="form-control"
                                        required value="{{ old('father_name') }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="contact_no" value="{{ $get_user->contact_no }}"
                                        class="form-control contact_number" placeholder="+XX-XXXXXXXXXX" required>
                                    <strong class="text-danger" id="contact_no"></strong>
                                </div>
                                <div class="col-md-4">
                                    <label for="validationCustom01" class="form-label">Teacher CNIC</label>
                                    <input type="cnic" name="cnic" value="{{ $get_user->cnic }}"
                                        class="form-control cnic_number" placeholder="XXXXX-XXXXXXX-X" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="single-select" onchange="changeFunc();" id="selectBoxp"
                                        name="enrollment" required>
                                        b <option selected disabled value="">--Select the Entrollment--</option>
                                        @if ($get_user->enrollment == 'permanent')
                                            @php
                                                $permanent = 'selected';
                                            @endphp
                                        @else
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" required id="address" name="address" rows="3" placeholder="Address...">{{ $get_user->address }}</textarea>
                                    ...
                                    <select class="single-select" data-placeholder="Choose..." multiple name="class[]"
                                        ...
                                        @foreach ($alldegree as $degree)
                                            <option value="{{ $degree->id }}"
                                                @if (in_array($degree->id, unserialize($get_user->class))) selected @endif>
                                    ...
                                    <select class="single-select" data-placeholder="Choose..." multiple name="program[]"
                                        ...
                                        @foreach ($allprogram as $program)
                                            <option value="{{ $program->id }}"
                                                @if (in_array($program->id, unserialize($get_user->program))) selected @endif>
                                                {{ ucfirst($program->program_name) }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="single-select" id="validationCustom04" name="teacher_degree_status"
                                        ...
                                        @if ($get_user->teacher_degree_status)
                                            @php
                                                $complete = 'selected';
                                            @endphp
                                        @else
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" oninput="allow_alphabets(this)" class="form-control"
                                        ...
                                        value="{{ $get_user->teacher_university }}" placeholder="Enter Univeristy Name"
                                        required>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select name="teacher_degree" class="single-select" required>
                                        ...
                                        @else
                                            ...
                                            @endphp
                                        @endif
                                        <option value="Bachelors" {{ @$bachelor }}>Bachelors</option>
                                ...
                                <div class="col-md-8">
                                    ...
                                    @php
                                        $implode = implode(',', unserialize($get_user->teacher_professional_field));
                                    @endphp
                                    <input type="text" name="teacher_professional_field" value="{{ $implode }}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" required id="description" name="description" value="{{ $get_user->description }}" rows="3" placeholder="Enter Description..."></textarea>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-6 text-end">
                                        <button class="btn rounded-pill btn-primary waves-effect waves-light"
                                            type="submit" id="update">Update Teacher > </button>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <div class="col-lg-3" id="image_thumbnail">
                <img class="img-thumbnail" alt="200x200" width="450" height="200"
                    src="{{ asset('admin/assets/images/instructors/' . $get_user->teacher_picture) }}">
            </div>
        </div>
    </div>
    </div>

                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
                                <div class="row g-4">
                                    <div class="col-auto">
                                        <div class="avatar-lg" id="teacherImage">
                                                                    ...
                                                                    <table class="table table-borderless mb-0">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <th class="text-muted" id="degree"
                                                                                    style="text-transform: capitalize"></th>
                                                                            </tr>
                                                                            <tr>
                                                                                <th class="ps-0" scope="row">
                                                                                    Qualification:
                                                                                </th>
                                                                                <th class="text-muted" id="teacher_degree"
                                                                                    style="text-transform: capitalize"></th>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a href="{{ url('/teacher/' . $teacher->id . '/edit/') }}"
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item remove-item-btn delete"
                                                            data-del="{{ $teacher->id }}" style="cursor: pointer;">
            ...
            $(document).on("click", ".detail", function(stop) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#percentage").empty();
                        $("#year").empty();
                        $("#teacherImage img").empty();
                        $("#teacher_degree").empty();
                        $("#sibling_name").empty();
                        ...
                        $("#teacher_degree").append(titleCase(response.message.teacher_degree));
                        ...
                        $("#teacherImage img").attr("src", "/admin/assets/images/instructors/" +
                            response.message.teacher_picture);

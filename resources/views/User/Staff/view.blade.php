                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h5><span class="badge badge-label bg-primary"><i
                                                    ...
                                                    {{ 'Reg-' . $staff->registeration_no }}</span></h5>
                                        </td>
                                        ...
                                        <td>
                                            <h5><span class="badge badge-soft-primary">{{ 'Staff' }}</span></h5>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a href="{{ url('/staff/' . $staff->id . '/edit/') }}"
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item remove-item-btn delete"
                                                            data-del="{{ $staff->id }}" style="cursor: pointer;">
                                                            <i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i>
                                                            Delete
                                                        </a>
                                                    </li>
                                                    <li><a class="dropdown-item edit-item-btn detail"
                                                            data-detail="{{ $staff->id }}" style="cursor: pointer;"><i
